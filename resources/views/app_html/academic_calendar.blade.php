...
<body id="page-top">
		...
		<div class="container">
			...
			<div class="collapse navbar-collapse" id="navbarResponsive">
				<ul class="navbar-nav ml-auto">
					<li class="nav-item">
						<a id="cal_li" class="nav-link js-scroll-trigger" href="#page-top">Academic Calendar</a>
					</li>
					<li class="nav-item">
	...
	<header class="intro">
		<div class="container">
			...
			<h3>The academic calendar works under the light of an algorithm that focuses on programming your pending events, allowing you to establish a pattern of studies much more optimized and according to the available time.</h3>	
		</div>
	</header>
