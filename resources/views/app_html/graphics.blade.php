...
<body id="page-top">
		...
		<div class="container">
			...
			<div class="collapse navbar-collapse" id="navbarResponsive">
				<ul class="navbar-nav ml-auto">
					...
					<li class="nav-item">
						<a id="graf_li" class="nav-link js-scroll-trigger" href="#page-top">Graphics</a>
					</li>
					<li class="nav-item">
	...
	<header class="intro">
		<div class="container">
			<h1>Graphics</h1>
			<h3>The app have an interactive graphic, to do a comparison between current and previous periods allowing to recognize in what percentage it has been improved or worsened.</h3>
		</div>
	</header>
